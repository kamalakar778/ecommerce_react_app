            ...
            <div className="container-fluid py-2">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div style={{ display: "flex" }}>
                        <DropdownButton id="dropdown-button" title={"Login or Signup"}>
                            ...
                            <Dropdown.Item href="/favourites">
                                ...
                                </svg>&nbsp;Favourites</Dropdown.Item>
                        </DropdownButton>
                        <div class="dropdown btn btn-light transparentbar" style={{ webkitAppearance: 'none' }} >
                            {/* <button type="button" class="btn btn-outline-dark" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            </button> */}
                            <a style={{ fontSize: "20px", textDecoration: "none", paddingRight: "20em" }} href="/cart">
